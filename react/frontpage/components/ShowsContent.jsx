						...
						<Col xs={12} md={7}>
							...
							<div style={{ width: '100%', margin: '0 auto' }}>
								<p style={timeStyle}>9am</p> 
									{slots9am.map(item => (
										 <ShowBlock day={item.day} showData={showData} time={item.time} getCurDay={this.getCurDay} getCurHour={this.getCurHour} dDay={this.state.dDay} dHour={this.state.dHour} clickHandler={this.handleClick} hoverHandler={this.handleShowChange} />
									))}
							</div>
