...
var StatusFilter = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      'div',
      { className: 'form-group' },
      React.createElement('h3', null, 'Point Status'),
      React.createElement(
        'select',
        {
          name: 'point_status',
        ...
        React.createElement('option', { value: 'all' }, 'Any'),
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('option', { value: 'fundraising' }, 'Fundraising'),
        ...
        React.createElement('option', { value: 'photo' }, 'Photo/Video'),
        React.createElement('option', { value: 'productions' }, 'Productions'),
        React.createElement('option', { value: 'programming' }, 'Programming'),
        React.createElement('option', { value: 'promotions' }, 'Promotions'),
        React.createElement('option', { value: 'sports' }, 'Sports'),
        React.createElement('option', { value: 'web' }, 'Web'),
        React.createElement('option', { value: 'interns' }, 'Interns')
      )
    );
  },
});
...
var StaffingPointsRow = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      'tr',
      null,
      React.createElement('td', null, this.props.record.fullName),
      React.createElement('td', null, this.props.record.number),
      React.createElement('td', null, this.props.record.description),
      React.createElement('td', null, this.props.record.department),
      React.createElement(
        'td',
        null,
        this.props.record.dateCompleted.toDateString()
      ),
      React.createElement('td', null, this.props.record.notes),
      React.createElement('td', null, this.props.record.status),
      React.createElement(
        'td',
        { onClick: this.updateStatus.bind(null, 'approved') },
        React.createElement('button', null, 'Approve')
      ),
      React.createElement(
        'td',
        { onClick: this.updateStatus.bind(null, 'denied') },
        React.createElement('button', null, 'Deny')
      ),
      React.createElement(
        'td',
        null,
...
var StaffingPointsTable = React.createClass({
  ...
  render: function render() {
    ...
    var rows = records.map(function(record) {
      return React.createElement(StaffingPointsRow, {
        key: record._id,
        record: record,
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('th', null, 'Approve'),
          React.createElement('th', null, 'Deny'),
          React.createElement('th', null, 'Manager Notes')
        )
      ),
...
var StaffingPointsView = React.createClass({
  ...
  updateStatus: function updateStatus(statusMessage, newStatus, id) {
    if (statusMessage !== 'incorrect password') {
      ...
      var records = [].concat(
        _toConsumableArray(this.state.records.slice(0, recordToUpdateIndex)),
        [newRecord],
        _toConsumableArray(
  ...
  render: function render() {
    return React.createElement(
      'div',
      null,
      React.createElement('h1', { id: 'header' }, 'Staffing Points'),
      React.createElement('h4', null, this.state.statusMessage),
      React.createElement(
        'div',
        { className: 'row' },
        React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'form-group' },
            React.createElement('h3', null, 'Super Secret Password'),
            React.createElement('input', {
              type: 'password',
              name: 'password',
              className: 'form-control',
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'col-md-3' },
          React.createElement(NameFilter, {
...
ReactDOM.render(
  React.createElement(StaffingPointsView, null),
