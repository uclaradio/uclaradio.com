          ...
          d =
            d === 'true'
              ...
              : d === 'false'
                ...
                : d === 'null'
                  ? null
                  : f.isNumeric(d) ? +d : j.test(d) ? f.parseJSON(d) : d;
        } catch (g) {}
        f.data(a, c, d);
      } else d = b;
    }
        ...
        for (k = 0; k < j.length && !c.isPropagationStopped(); k++) {
          ...
          for (
            ...
            if (
              ...
              (c.data = s.data),
                (c.handleObj = s),
                (o = ((f.event.special[s.origType] || {}).handle || s.handler)
                  .apply(q.elem, g)),
                o !== b &&
                  ((c.result = o),
          ...
          k.length &&
            f.each(k, function(a, b) {
              b.src
                ...
                : f.globalEval(
                    (b.text || b.textContent || b.innerHTML || '')
                      .replace(bf, '/*$0*/')
                  ),
  ...
  'getBoundingClientRect' in c.documentElement
    ...
    f.each({ Height: 'height', Width: 'width' }, function(a, c) {
      ...
      (f.fn['inner' + a] = function() {
        var a = this[0];
        return a
          ? a.style ? parseFloat(f.css(a, c, 'padding')) : this[c]()
          : null;
      }),
